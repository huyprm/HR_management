...
//
//        if (salaryRepository.existsByUserIdAndStartDateAndEndDate(user.getId(), salaryRequest.getStartDate(), salaryRequest.getEndDate())) {
...
//        }
//
//        int numberOfWorkingDays = LeaveBalanceUtil.calculateActualWorkingDays(salaryRequest.getStartDate(), salaryRequest.getEndDate(), leaveDayRepository);
//
//        Salary salary = salaryMapper.toSalary(salaryRequest);
//
//        salary.setUser(user);
//        salary.setContract(contract);
//        salary.setBaseSalary(contract.getBasicSalary() * contract.getJobGrade().getCoefficient());
//        salary.setNumberOfLeaveDays(leaveApplicationService.getTotalLeaveDaysByUserId(user.getId(), salaryRequest.getStartDate(), salaryRequest.getEndDate()));
//        salary.setPaymentDate(LocalDate.now());
//        salary.setAllowance(calculateTotalAllowance(contract, seniorityAllowancePercentage));
//        salary.setNumberOfWorkingDays(numberOfWorkingDays);
...
//            if (salaryRepository.existsByUserIdAndStartDateAndEndDate(user.getId(), firstDayOfMonth, lastDayOfMonth)) {
//                continue;
//            }
//
