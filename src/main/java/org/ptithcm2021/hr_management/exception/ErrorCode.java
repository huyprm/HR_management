...
public enum ErrorCode {
    ...
    // Thêm các mã lỗi mới cho LeaveBalance theo tháng
    INVALID_LEAVE_APPLICATION(1048, "Invalid leave application data", HttpStatus.BAD_REQUEST),
    INVALID_MONTH(1049, "Invalid month value", HttpStatus.BAD_REQUEST),
    MONTH_YEAR_LEAVE_BALANCE_EXISTS(1050, "Leave balance for this month and year already exists", HttpStatus.CONFLICT),
    LEAVE_BALANCE_EXCEEDED(1051, "Leave balance exceeded allowed days", HttpStatus.BAD_REQUEST);
